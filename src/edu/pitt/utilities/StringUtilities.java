...
public class StringUtilities {
	 ...
	 * 
	 * @param extension
	 *            - Extension of a file, usually a .txt
	 * @return File name
	 */
	public static String dateToFilename(String extension) {
		Date tempDate = new Date();
		return tempDate.getMonth() + "_" + tempDate.getDay() + "_"
				+ tempDate.getYear() + "." + extension;
	}
	 ...
	 * 
	 * @param str
	 *            - String variable - we need to check if it can be converted to
