...
public class MySqlUtilities implements DbUtilities{
	...
	private String dbName = "kdr35_bank1017"; // default database name
	private String dbUserName = "kdr35"; // login name for the databaseserver
	private String dbPassword = "1445074"; // password for the database server
	 ...
	 */
	public MySqlUtilities(String hostName, String dbName, String dbUserName,
			String dbPassword) {
	...
	private void createDbConnection() {
		try {
			...
			String mySqlConn = "jdbc:mysql://" + hostName + "/" + dbName
	...
	public DefaultTableModel getDataTable(String sql) throws SQLException {
		...
		// Get column names from the metadata object and store them in a Vector
		// variable
